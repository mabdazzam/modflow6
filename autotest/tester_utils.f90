...
contains
  !> @brief Check if two matrices A and B are the same within a given tolerance.
  !!
  ...
  !> @brief Checks if the given matrix A is diagonal within a specified tolerance.
  !!
  ...
  !> @brief Checks if the given matrix A is bidiagonal within a specified tolerance.
  !!
