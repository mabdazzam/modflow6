...
\hline
DIS6 & Rectilinear Discretization Input File & no \\
DISV6 & Discretization by Vertices Input File & no \\
MIP6 & Model Input File & no \\
FMI6 & Flow Model Interface Package & no  \\ 
PRP6 & Particle Release Point Package & yes \\
OC6 & Output Control Option & no \\
\hline 
\end{tabular*}
